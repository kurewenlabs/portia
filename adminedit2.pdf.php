...
<body>
 <div class="container">
    <section style="border:1px solid #eee; margin-top: 30px; padding-left: 10px"> <!--esto es para despues --->
        <p><strong>Fecha de Postulacion :</strong></p>
    ...
    <div class="row">
        <div class="col s6 m6 l6">
            <p><strong>Cargo al que postula :</strong> </p> 
            <p><strong>RUT Numero : </strong></p> 
            <p><strong>Pasaporte Numero :</strong> </p> 
        ...
        <div class="col s6 m6 l6 ">
           <p><strong>Estado Civil :</strong> </p>    
            ...
            <p><strong>Region : </strong></p> <!--pasar aqui comuna y region -->     
        ...
        <div class="row">
            <div class="col s6 m6 l6">
                <h5>Estudios : </h5><p> </p> <!-- passar aqui tipo de estudios -->       
                 <p><strong>Titulo de la carrera :  </strong></p> 
                 <p><strong>Estado :</strong> </p><!-- pasar año y semestres cursados -->
    ...
    <div class="divider"></div>
        ...
        <div class="row">
            ...
            <div class="col s6 m6 l6">
                <p><strong>Isapre o Fonasa :</strong></p>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col s6 m6 l6 ">
            <p><strong>Talla Polera/camisa :</strong></p>        
            <p><strong>Talla Poleron :</strong></p>
            <p><strong> Talla de zapatos :</strong></p>
            <p><strong>Talla de Pantalon :</strong></p>
