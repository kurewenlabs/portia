...
?>
    ...
    <body>
                ...
                <div id="modal2" class="modal">
                    <div class="modal-content">
                        ...
                        <div class="row">
                            <div class="col s12 m3 l3">
                                ...
                                <div id="retail">
                                    <p>
                                        <label for="r1">
                                            <input type="radio" name="cargo" value="reponedor supermercados" data-index="1" id="r1">
                                            <span>Reponedor supermercados</span>
                                        </label>
                                    </p>
                                    <p>
                                        <label for="r2">
                                            <input type="radio" name="cargo" value="reponedor grandes superficies" data-index="2" id="r2">
                                            <span>Reponedor grandes superficies</span>
                                        </label>
                                    </p>
                                    <p>
                                        <label for="r3">
                                            <input type="radio" name="cargo" value="promotor grandes tiendas" data-index="3" id="r3">
                                            <span>Promotor (a) grandes tiendas</span>
                                        </label>
                                    </p>
                                    <p>
                                        <label for="r4">
                                            <input type="radio" name="cargo" value="promotor supermercados" data-index="4" id="r4">
                                            <span>Promotor (a) supermercados</span>
                                        </label>
                                    </p>
                                    <p>
                                        <label for="r5">
                                            <input type="radio" name="cargo" value="vendedor de intangibles" data-index="5" id="r5">
                                            <span>vendedor de intangibles</span>
                                        </label>
                                    </p>
                                    <p>
                                        <label for="r6">
                                            <input type="radio" name="cargo" value="vendedor de tangibles" data-index="6" id="r6">
                                            <span>vendedor de tangibles</span>
                                        </label>
                                    </p>
                                    <p>
                                        <label for="r7">
                                            <input type="radio" name="cargo" value="supervisor de promotores" data-index="7" id="r7">
                                            <span>Supervisor de promotores</span>
                                        </label>
                                    </p>
                                    <p>
                                        <label for="r8">
                                            <input type="radio" name="cargo" value="supervisor de mercaderistas" data-index="8" id="r8">
                                            <span>Supervisor de mercaderista</span>
                                        </label>
                                    </p>
                                    <p>
                                        <label for="r9">
                                            <input type="radio" name="cargo" value="merchandising" data-index="9" id="r9">
                                            <span>Merchandising</span>
                                        </label>
                                    </p>
                                    <p>
                                        <label for="r10">
                                            <input type="radio" name="cargo" value="trade marketing" data-index="10" id="r10">
                            ...
                            <div class="col s12 m3 l3">
                                ...
                                <div id="administrativo">
                                    <p>
                                        <label for="a1">
                                            <input type="radio" name="cargo" value="digitador" id="a1" data-index="11">
                                            <span>Digitador</span>
                                        </label>
                                    </p>
                                    <p>
                                        <label for="a2">
                                            <input type="radio" name="cargo" value="asistente de calidad" data-index="12" id="a2">
                                            <span>Asistente de calidad</span>
                                        </label>
                                    </p>
                                    <p>
                                        <label for="a3">
                                            <input type="radio" name="cargo" value="asistente contable" data-index="13" id="a3">
                                            <span>Asistente contable</span>
                                        </label>
                                    </p>
                                    <p>
                                        <label for="a4">
                                            <input type="radio" name="cargo" value="ejecutiva de cuenta" data-index="14" id="a4">
                                            <span>Ejecutiva de cuenta</span>
                                        </label>
                                    </p>
                                    <p>
                                        <label for="a5">
                                            <input type="radio" name="cargo" value="analista de invetario" data-index="15" id="a5">
                                            <span>Analista de inventario</span>
                                        </label>
                                    </p>
                                    <p>
                                        <label for="a6">
                                            <input type="radio" name="cargo" value="gestor de ventas" data-index="16" id="a6">
                                            <span>Gestor de ventas</span>
                                        </label>
                                    </p>
                                    <p>
                                        <label for="a7">
                                            <input type="radio" name="cargo" value="ejecutivo de call center" data-index="17" id="a7">
                                            <span>Ejecutivo de call center</span>
                                        </label>
                                    </p>
                                    <p>
                                        <label for="a8">
                                            <input type="radio" name="cargo" value="informatico" data-index="18" id="a8">
                                            <span>Informático</span>
                                        </label>
                                    </p>
                                    <p>
                                        <label for="a9">
                                            <input type="radio" name="cargo" value="alumno en practica" data-index="19" id="a9">
                                            <span>Alumno en practica</span>
                                        </label>
                                    </p>
                                    <p>
                                        <label for="a10">
                                            <input type="radio" name="cargo" value="secretaria" data-index="20" id="a10">
                                            <span>Secretaria</span>
                                        </label>
                                    </p>
                                    <p>
                                        <label for="a11">
                                            <input type="radio" name="cargo" value="junior" data-index="21" id="a11">
                                            <span>Junior</span>
                                        </label>
                                    </p>
                                    <p>
                                        <label for="a12">
                                            <input type="radio" name="cargo" value="capacitador" data-index="22" id="a12">
                                            <span>Capacitador</span>
                                        </label>
                                    </p>
                                    <p>
                                        <label for="a13">
                                            <input type="radio" name="cargo" value="captador" data-index="23" id="a13">
                                            <span>Captador</span>
                                        </label>
                                    </p>
                                    <p>
                                        <label for="a14">
                                            <input type="radio" name="cargo" value="administrativo de archivo" data-index="24" id="a14">
                                            <span>Administrativo de Archivo</span>
                                        </label>
                                    </p>
                                    <p>
                                        <label for="a15">
                                            <input type="radio" name="cargo" value="ejecutiva de beneficios" data-index="25" id="a15">
                                            <span>Ejecutiva de beneficios</span>
                                        </label>
                                    </p>
                                    <p>
                                        <label for="a16">
                                            <input type="radio" name="cargo" value="administrativo de despacho" data-index="26" id="a16">
                            ...
                            <div class="col s12 m3 l3">
                                ...
                                <div id="industrial">
                                    <p>
                                        <label for="i1">
                                            <input type="radio" name="cargo" value="conductor grua horquilla" data-index="27" id="i1">
                                            <span>Conductor grua horquilla</span>
                                        </label>
                                    </p>
                                    <p>
                                        <label for="i2">
                                            <input type="radio" name="cargo" value="operario produccion" data-index="28" id="i2">
                                            <span>Operario producción</span>
                                        </label>
                                    </p>
                                    <p>
                                        <label for="i3">
                                            <input type="radio" name="cargo" value="operario de bodega" data-index="29" id="i3">
                                            <span>Operario de bodega</span>
                                        </label>
                                    </p>
                                    <p>
                                        <label for="i4">
                                            <input type="radio" name="cargo" value="manipuladoras de alimentos" data-index="30" id="i4">
                                            <span>Manipuladoras de alimentos</span>
                                        </label>
                                    </p>
                                    <p>
                                        <label for="i5">
                                            <input type="radio" name="cargo" value="maestro panadero" data-index="31" id="i5">
                                            <span>Maestro Panadero</span>
                                        </label>
                                    </p>
                                    <p>
                                        <label for="i6">
                                            <input type="radio" name="cargo" value="maestro de cocina" data-index="32" id="i6">
                                            <span>Maestro de cocina</span>
                                        </label>
                                    </p>
                                    <p>
                                        <label for="i7">
                                            <input type="radio" name="cargo" value="Ayudante de cocina" data-index="33" id="i7">
                                            <span>Ayudante de cocina</span>
                                        </label>
                                    </p>
                                    <p>
                                        <label for="i8">
                                            <input type="radio" name="cargo" value="ayudante de panadero" data-index="34" id="i8">
                                            <span>Ayudante de panadero</span>
                                        </label>
                                    </p>
                                    <p>
                                        <label for="i9">
                                            <input type="radio" name="cargo" value="Runner" id="i9" data-index="35">
                                            <span>Runner</span>
                                        </label>
                                    </p>
                                    <p>
                                        <label for="i10">
                                            <input type="radio" name="cargo" value="Peoneta" id="i10" data-index="36">
                                            <span>Peoneta</span>
                                        </label>
                                    </p>
                                    <p>
                                        <label for="i11">
                                            <input type="radio" name="cargo" value="colorista" id="i11" data-index="37">
                                            <span>Colorista</span>
                                        </label>
                                    </p>
                                    <p>
                                        <label for="i12">
                                            <input type="radio" name="cargo" value="carnicero" id="i12" data-index="38">
                                            <span>Carnicero</span>
                                        </label>
                                    </p>
                                    <p>
                                        <label for="i13">
                                            <input type="radio" name="cargo" value="envasador" id="i13" data-index="39">
                                            <span>Envasador</span>
                                        </label>
                                    </p>
                                    <p>
                                        <label for="i14">
                                            <input type="radio" name="cargo" value="empaquetador" id="i14" data-index="40">
                                            <span>Empaquetador</span>
                                        </label>
                                    </p>
                                    <p>
                                        <label for="i15">
                                            <input type="radio" name="cargo" value="mecanico" id="i15" data-index="41">
                                            <span>Mecánico</span>
                                        </label>
                                    </p>
                                    <p>
                                        <label for="i16">
                                            <input type="radio" name="cargo" value="encargado de area" id="i16" data-index="42">
                                            <span>Encargado de area</span>
                                        </label>
                                    </p>
                                    <p>
                                        <label for="i17">
                                            <input type="radio" name="cargo" value="supervisor de producción" id="i17" data-index="43">
                            ...
                            <div class="col s12 m3 l3">
                                ...
                                <div id="otros">
                                    ...
                                    <p>
                                        <label for="o1">
                                            <input type="radio" name="cargo" value="conductor licencia A3" id="o1" data-index="44">
                                            <span>Conductor licencia A3</span>
                                        </label>
                                    </p>
                                    <p>
                                        <label for="o2">
                                            <input type="radio" name="cargo" value="conductor licencia B" id="o2" data-index="45">
                                            <span>Conductor licencia B</span>
                                        </label>
                                    </p>
                                    <p>
                                        <label for="o3">
                                            <input type="radio" name="cargo" value="guardia" id="o3" data-index="46">
                                            <span>Guardia</span>
                                        </label>
                                    </p>
                                    <p>
                                        <label for="04">
                                            <input type="radio" name="cargo" value="Auxiliar de aseo" id="04" data-index="47">
                                            <span>Auxiliar de aseo</span>
                                        </label>
                                    </p>
                                    <p>
                                        <label for="o5">
                                            <input type="radio" name="cargo" value="Asesora del hogar" id="o5" data-index="48">
                                            <span>Asesora del hogar</span>
                                        </label>
                                    </p>
                                    <p>
                                        <label for="06">
                                            <input type="radio" name="cargo" value="Manicuristas" id="06" data-index="49">
                                            <span>Manicuristas</span>
                                        </label>
                                    </p>
                                    <p>
                                        <label for="07">
                                            <input type="radio" name="cargo" value="Cajero" id="07" data-index="50">
                                            <span>Cajero</span>
                                        </label>
                                    </p>
                                </div>
                        ...
                        <div class="modal-footer">
                            <a href="#" onclick="actualizaCargo('<?php echo $id; ?>', '<?php echo $postula; ?>');" class="modal-close waves-effect waves-green btn-flat">Actualizar</a>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div id="datosPersonales">
                            ...
                            <div class=" input-field col s4 m4 l4 " id="rut_box">
                                ...
                                <input name="rut" placeholder="Ingrese rut con digito verificador" id="rut" type="text" class="validate" value="<?php echo ($result['tipo_documento']=="rut"?$result['rut']:""); ?>" onblur="esRUT(this);">
                            </div>
        ...
        <script language="Javascript">
            ...
            // Cargo Seleccionado
            $('input:radio[name="cargo"]').val(['<?php echo strtolower($result['nombre']); ?>']);    
